...
- (void)loadWebView {
    ...
    NSString *consentFormPath = @"consentform";
    
    NSArray *supportedLanguages = @[@"fr", @"cn", @"de", @"es", @"fr", @"it", @"ja", @"ko", @"nl", @"pt", @"ru"];
    BOOL contains = [supportedLanguages containsObject:preferredLocalization];
    
    if (contains == YES) {
        consentFormPath = [NSString stringWithFormat:@"%@_%@", consentFormPath, preferredLocalization];
    }
